...
def count_perimeter(object):
    ...
    perimeter = skimage.measure.perimeter(object_int, 8)
...
def predict_data(knn, features_test_data, filenames):
    index = 0
...
if __name__ == "__main__":
    ...
    predict_data(knn, features_test_data, filenames)
    print()
